package com.spring.cloud.common.until.enums;
...
public enum ServiceCodeEnum {
     ...
     * 存在下架或更换渠道商品，下单失败
     */
    GOODS_TAKEN_OFF(417, "存在下架或更换渠道商品，下单失败"),

    /**
     * 存在下架或更换渠道商品，下单失败
     */
    GOODS_PRICE_CHANGED(418, "商品价格变更，请重新下单"),

    /**
     * 存在下架或更换渠道商品，下单失败
     */
    FREIGHT_AMOUNT_CHANGED(419, "运费规则变更，请重新下单"),
     ...
     * 该商品在该地区暂不支持销售
     */
    NOT_IN_AREA(610, "该商品在该地区暂不支持销售"),

    /**
     * 所选商品已失效
     */
    COMMODITY_ABNORMAL_STATE(611, "所选商品已失效"),

    /**
     * 所选商品库存不足
     */
    COMMODITY_ABNORMAL_NUM(612, "所选商品库存不足"),
    /**
     * 家庭移除操作（唯一码）
     */
    FAMILY_EXCLUDE(700, "已被家庭移除"),

    /**
     * 您有一笔订单未支付，请前往支付
     */
    PAYMENT_ORDER(701, "您有一笔订单未支付，请前往支付"),


    /**
     * 因你长时间未操作，请重新选择受赠人。
     */
    GIFT_TIMEOUT(702, "因你长时间未操作，请重新选择受赠人。"),
     ...
     * 该账号已在其他设备上登录
     */
    ACCESS_TOKEN_IN_OTHER_DEVICES(904, "该账号已在另一台设备上登录"),
    /**
     * Token验证失败
     */
    ...
    USER_LOCKED(907, "账号被锁定"),
    /**
     * 未知错误，认证失败
     */
    QUEUE_BUSY(910, "当前使用人数较多，请稍等片刻"),
